...
def get_completion(messages: List[Dict[str, Any]], model: str, stream: bool = False, **kwargs) -> Union[Generator[str, None, None], str]:
    """
...
async def async_get_completion(messages: List[Dict[str, Any]], model: str, **kwargs) -> str:
    """
